			...
			<div id="FB-block">
						...
						<div class="flexWrap">
							<div class="box hasFooterButton">
								<div class="dataset">
									...
									<tbody>
										<router-link class="clickableRow" v-for="(block, index) in blocks" :key="index" v-bind:to="`/desktop/blockchain/Block/${block.blockID}`" tag="tr">
											<td>{{block.blockID}}</td>
				...
				<ContentWidget 
					...
					<div class="flexbox">
							...
							<div class="box">
								...
								<div class="dataset">
									...
									<div v-else>
										...
										<tbody>
											<router-link class="clickableRow" v-for="(transaction, index) in transactions[filterTransaction]" :key="index" v-bind:to="`/desktop/blockchain/Transaction/${transaction.latestBlockLvl}/${transaction.latestBlockVal}/${transaction.key}`" tag="tr">
						...
						<!--<router-link to="/desktop/blockchain/AllTransactions" tag="button" class="activeButton">
