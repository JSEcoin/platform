		...
		<ScrollWidget v-bind="{noSubNav:true}">
			<div id="FB-activeBlockSection" class="connected box">
				<h3 class="title highLight">
					<ul id="JSE-blockNav">
						<router-link class="previous" v-bind:to="`/desktop/blockchain/Block/${prevBlock}`" v-if="prevExists" tag="li">
						...
						<router-link class="next" v-bind:to="`/desktop/blockchain/Block/${nextBlock}`" v-if="nextExists" tag="li">
