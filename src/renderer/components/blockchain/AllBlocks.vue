			...
			<ContentWidget 
				...
				<template slot="footer">
					<div class="row" style="justify-content:center;">
						<router-link class="previous" v-bind:to="`/desktop/blockchain/AllBlocks/${latestBlockLvl}/${prevBlock}`" v-if="prevExists" tag="li">
							<i class="fa fa-angle-left icon-chevron-left"></i> Previous
						</router-link>
						<li v-else>.</li>

						<router-link class="next" v-bind:to="`/desktop/blockchain/AllBlocks/${latestBlockLvl}/${nextBlock}`" v-if="nextExists" tag="li">
