	...
	created() {
		//if (typeof (window.socketClient) === 'undefined') {
			...
			window.socketClient.on('newBlock', function(myBlockRef,myBlockID,myBlock) {
				...
				if (typeof window.global.currentChain[myBlockRef] === 'undefined') window.global.currentChain[myBlockRef] = {};
				window.global.currentChain[myBlockRef][myBlockID] = myBlock;
			});
			...
			return new Promise((resolve) => {
				socketClient.emit('getChainData', key, (returnObject) => {
						...
						if (keySplit.length === 2) {
							...
							if (typeof window.global.currentChain[keySplit[0]] === 'undefined') window.global.currentChain[keySplit[0]] = {};
							window.global.currentChain[keySplit[0]][keySplit[1]] = returnObject;
						}
			...
			window.socketClient.getChainData = async function(key,callback) {
				...
				if (keySplit.length === 1) {
					if (window.global.currentChain[keySplit[0]]) {
						callback(window.global.currentChain[keySplit[0]]);
						return;
					}
				} else if (keySplit.length === 2) {
					if (window.global.currentChain[keySplit[0]] && window.global.currentChain[keySplit[0]][keySplit[1]]) { // double check the parents exist to avoid errors, throw a null back if any keys are undefined
						callback(window.global.currentChain[keySplit[0]][keySplit[1]]);
						return;
					}
				} else if (keySplit.length === 3) {
					if (window.global.currentChain[keySplit[0]] && window.global.currentChain[keySplit[0]][keySplit[1]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]]) {
						callback(window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]]);
						return;
					}
				} else if (keySplit.length === 4) {
					if (window.global.currentChain[keySplit[0]] && window.global.currentChain[keySplit[0]][keySplit[1]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]]) {
						callback(window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]]);
						return;
					}
				} else if (keySplit.length === 5) {
					if (window.global.currentChain[keySplit[0]] && window.global.currentChain[keySplit[0]][keySplit[1]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]][keySplit[4]]) {
						callback(window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]][keySplit[4]]);
						return;
					}
					...
					if (window.global.currentChain[keySplit[0]] && window.global.currentChain[keySplit[0]][keySplit[1]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]][keySplit[4]] && window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]][keySplit[4]][keySplit[5]]) {
						callback(window.global.currentChain[keySplit[0]][keySplit[1]][keySplit[2]][keySplit[3]][keySplit[4]][keySplit[5]]);
						return;
					}
				} else {
